...
@Pyro5.api.expose
class clsLab3LamportMutualExclusion(ILab3LamportMutualExclusion):

    # pass process id also
    #Assume there are three process.
    ProcessP0 = 0
    ProcessP1 = 0
    ProcessP2 = 0
    AllProcesses = []
...
#requestCriticalSection(): Requests entry to the critical section.
    def requestCriticalSection(self):
        try:
            print ("RequestCriticalSection : There are three process such as P0, P1 and P2");
